        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
            <form className="space-y-4" onSubmit={handleSignup}>
              ...
              <Button type="submit" className="w-full bg-slate-900 hover:bg-slate-800 h-12 rounded-xl mt-4">
      ...
      <div className="hidden lg:flex flex-1 bg-slate-900 p-12 items-center justify-center text-white">
        <div className="max-w-lg">
          ...
          <div className="mt-16 p-8 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm">
            <p className="text-xl italic text-slate-300 mb-6">"Guardian AI has completely transformed how we handle community safety. It's fast, accurate, and incredibly easy to integrate."</p>
