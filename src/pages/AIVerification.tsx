...
const AIVerification = () => {
  return (
    <DashboardLayout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">AI Verification Bot</h1>
        <p className="text-slate-500">Automated identity verification and bot behavior analysis.</p>
      </div>
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                ...
                <div className="text-right">
                  <Badge className={item.status === 'Verified' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'}>
                    {item.status}
                  </Badge>
